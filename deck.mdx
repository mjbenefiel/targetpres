...
<Head>
  <title>Tealium Presentation</title>
...
```notes
- <img src="./assets/tealium_logo_color.svg" />
...
<ol style={{ margin: '25px 0', color:'#007CC2', fontSize:'4vw' }}>I'm Michael Benefiel</ol>
<ol style={{ margin: '25px 0', color:'#007CC2', fontSize:'2vw' }}>It's April 1, 2019</ol>
